...
@Entity
public class Expenditure extends ResponseObject {
    @Id
    ...
    public Expenditure(String title, String description, Double rate, String currency, Long timestamp, HashMap<String, String> customAttributes, Integer monthly) {
        this.title = title;
